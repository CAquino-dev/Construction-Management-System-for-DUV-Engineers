...
const calculateEstimate = async (data) => {
    const { projectType, materialType, sizeInSqm, location } = data;  // Get projectType, materialType, area in sqm, and location
...
const getEstimate = async (req, res) => {
  const { projectType, materialType, sizeInSqm, location } = req.body;
  try {
    // Call the calculateEstimate function and get the estimated cost
    const estimate = await calculateEstimate({ projectType, materialType, sizeInSqm, location });
