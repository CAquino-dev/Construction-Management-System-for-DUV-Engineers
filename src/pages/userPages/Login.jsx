...
const Login = () => {
  ...
  return (
    ...
    >
      ...
      {/* Mobile View - Original UI */}
      <div className="block lg:hidden relative w-full max-w-md">
      ...
      <div className="hidden lg:flex relative w-full max-w-6xl flex-row items-center justify-between gap-12">
        {/* Left Side - Branding & Info */}
        <div className="w-1/2 text-left text-white z-10">
          <div className="space-y-8 max-w-lg">
            ...
            {/* Company Name */}
            <div className="space-y-2">
              <h1 className="text-5xl font-bold">DUV</h1>
              <h2 className="text-3xl font-light opacity-90">ENGINEERS</h2>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-xl opacity-90 leading-relaxed">
                ...
                Access your projects, track progress, and collaborate
                seamlessly.
              </p>
            </div>
        ...
        <div className="w-1/2 max-w-md z-10">
          <div className="bg-white/95 backdrop-blur-lg rounded-3xl shadow-2xl p-10 transform transition-all duration-300 hover:shadow-3xl">
            {/* Card Header */}
            <div className="text-center mb-8">
