    ...
    <>
      <div className="flex fixed top-0 left-0 right-0 bg-[#4c735c] h-16 justify-between px-10 z-50">
        ...
        <div className="hidden md:flex items-center gap-10 text-white font-bold">
          <Link to="/our-team" className="hover:text-gray-400 transition">
            Our Team
          </Link>
          <Link to="/aboutus" className="hover:text-gray-400 transition">
            About Us
          </Link>
          <Link to="/chatbot" className="hover:text-gray-400 transition">
            ChatBot
          </Link>
      ...
      {/* Mobile Side Nav */}
      <div
        className={`fixed right-0 top-0 h-screen w-64 bg-[#4c735c] text-white font-bold flex flex-col p-6 transform transition-transform duration-300 ${
      ...
      >
        ...
        <div>
          <button
            className="py-2 flex items-center gap-2 hover:text-gray-300 transition"
      ...
      {menuOpen && (
        <div
          className="fixed top-0 left-0 w-full h-screen bg-opacity-40 z-40"
          onClick={() => setMenuOpen(false)}
        ></div>
      )}
    </>
