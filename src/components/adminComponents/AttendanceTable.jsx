...
const attendanceRecords = [
  ...
  { id: "M02490", name: "Robert Young", clockIn: "09:10 AM", clockOut: "06:10 PM", timeCount: "09:00:00", status: "Late", date: "2025-09-03" },
  { id: "M02509", name: "Elia Romero", clockIn: "-", clockOut: "-", timeCount: "-", status: "Leave Request", date: "2025-09-04" },
];
        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-[#4c735c] hover:bg-[#4c735c] text-white">
              <TableHead className="p-2 text-left text-white">Employee ID</TableHead>
              <TableHead className="p-2 text-left text-white">Full Name</TableHead>
              <TableHead className="p-2 text-center text-white hidden sm:table-cell">Clock In</TableHead>
              <TableHead className="p-2 text-center text-white hidden sm:table-cell">Clock Out</TableHead>
              <TableHead className="p-2 text-center text-white hidden sm:table-cell">Time Count</TableHead>
