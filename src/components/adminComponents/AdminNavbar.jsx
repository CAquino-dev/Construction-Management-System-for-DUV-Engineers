                ...
                <div className="relative hover:text-gray-400 cursor-pointer">
                    ...
                    {profileDropdownOpen && (
                        <div className="absolute right-0 mt-2 w-40 bg-white rounded-md shadow-lg py-2">
                            <button className="block px-4 py-2 text-black hover:bg-[#3b5d47] w-full" onClick={handleLogout}>Logout</button>
                        </div>
                    )}
                </div>
            </div>
                    ...
                    <ul className="space-y-4">
                        ...
                        .map((item, index) => (
                            <li key={index}>
                                <Link 
                                    to={item.href} 
                                    className={`flex items-center gap-3 p-3 rounded-lg font-semibold ${location.pathname === item.href ? "bg-[#5A8366] text-white" : "hover:bg-[#5A8366]"}`}
                                >
                                    {item.icon}
                                    {item.name}
                                </Link>
                                ...
                                <ul className="pl-6 mt-2 space-y-2">
                                    <li>
                                        <Link 
                                            ...
                                            className={`block p-2 rounded-lg ${location.pathname === "/admin-dashboard/engineer/projects" ? "bg-[#5A8366] text-white" : "hover:bg-[#5A8366]"}`}
                                        >
                                            Projects
                                        </Link>
                                    </li>
                                    <li>
                                        <Link
                                            ...
                                            className={`block p-2 rounded-lg ${location.pathname === "/admin-dashboard/engineer/my-project" ? "bg-[#5A8366] text-white" : "hover:bg-[#5A8366]"}`}
                                        >
                                            My Project
                                        </Link>
                                    </li>
                        ...
                        {permissions.can_access_finance === 'Y' && (
                            <li>
                                ...
                                {isFinanceOpen && (
                                    <ul className="pl-6 mt-2 space-y-2">
                                        <li>
                                            <Link to="/admin-dashboard/finance/approved-payroll-from-hr" className="block p-2 rounded-lg hover:bg-[#5A8366]">HR Payroll (Approved Records of HR)</Link>
                                        </li>
                                        <li>
                                            <Link to="/admin-dashboard/finance/approved-payroll-from-ceo" className="block p-2 rounded-lg hover:bg-[#5A8366]">HR Payroll (Approved Records of CEO)</Link>
                                        </li>
                                    </ul>
                                )}
                            </li>
                        ...
                        {permissions.can_access_hr === 'Y' && (
                            <li>
                                ...
                                {isHrOpen && (
                                    <ul className="pl-6 mt-2 space-y-2">
                                        <li>
                                            <Link to="/admin-dashboard/hr/attendance" className="block p-2 rounded-lg hover:bg-[#5A8366]">Attendance</Link>
                                        </li>
                                        <li>
                                            <Link to="/admin-dashboard/hr/payroll" className="block p-2 rounded-lg hover:bg-[#5A8366]">Payroll</Link>
                                        </li>
                                        <li>
                                            <Link to="/admin-dashboard/hr/employees" className="block p-2 rounded-lg hover:bg-[#5A8366]">Employee</Link>
                                        </li>
                                    </ul>
                                )}
                            </li>
