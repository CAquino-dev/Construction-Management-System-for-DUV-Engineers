...
export const TotalEmployeeCard = ({ totalEmployee }) => {
  return (
    <Card className="w-48 h-28 shadow-sm bg-[#3b5d47]/90 p-2 flex flex-col justify-center">
      <CardHeader className="flex items-center gap-2">
        ...
        <CardTitle className="text-xl font-bold text-white">Employee</CardTitle>
      </CardHeader>

      <CardContent className="text-center">
        <h2 className="text-2xl font-bold text-white">{totalEmployee || 0}</h2>
      </CardContent>
    </Card>
  )
}
